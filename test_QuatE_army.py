...
def main(args):
    ...
    RESTORE_CHECKPOINT_FNAME = args.restore_ckpt_fname
    con.set_test_link(True)
    con.set_test_triple(True)
    con.init()
    if RESTORE_CHECKPOINT_FNAME != None:
...
if __name__ == '__main__':
	...
	parser.add_argument('--restore_ckpt_fname', type=str, default=None, help='dataset directory')
